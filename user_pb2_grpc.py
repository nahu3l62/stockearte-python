...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateUser = channel.unary_unary(
                '/com.unla.stockearte.UserService/CreateUser',
        ...
        self.AuthenticateUser = channel.unary_unary(
                '/com.unla.stockearte.UserService/AuthenticateUser',
                request_serializer=user__pb2.AuthenticateUserRequest.SerializeToString,
                response_deserializer=user__pb2.UserResponse.FromString,
                _registered_method=True)
        self.AsignUserToStore = channel.unary_unary(
                '/com.unla.stockearte.UserService/AsignUserToStore',
                request_serializer=user__pb2.AsignUserToStoreRequest.SerializeToString,
                response_deserializer=user__pb2.UserResponse.FromString,
                _registered_method=True)
        self.EditUser = channel.unary_unary(
                '/com.unla.stockearte.UserService/EditUser',
                request_serializer=user__pb2.EditUserRequest.SerializeToString,
                response_deserializer=user__pb2.UserResponse.FromString,
                _registered_method=True)
        self.GetUsers = channel.unary_unary(
                '/com.unla.stockearte.UserService/GetUsers',
        ...
        self.GetUser = channel.unary_unary(
                '/com.unla.stockearte.UserService/GetUser',
...
class UserServiceServicer(object):
    ...
    def AsignUserToStore(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AsignUserToStore': grpc.unary_unary_rpc_method_handler(
                    servicer.AsignUserToStore,
                    request_deserializer=user__pb2.AsignUserToStoreRequest.FromString,
                    response_serializer=user__pb2.UserResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.unla.stockearte.UserService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('com.unla.stockearte.UserService', rpc_method_handlers)
...
class UserService(object):
    ...
    def AsignUserToStore(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/com.unla.stockearte.UserService/AsignUserToStore',
            user__pb2.AsignUserToStoreRequest.SerializeToString,
            user__pb2.UserResponse.FromString,
            options,
            channel_credentials,
            insecure,
